  ...
  return (
    <Layout title="G-Flight">
      <Container marginBottom={10}>
        ...
        <Paragraph>
          2019년 자료구조 수업 프로젝트로 진행한{" "}
          <Text as="b">HTML Canvas 게임</Text>입니다.
          <br />
          수업시간에 배운 개념인{" "}
          <Text as="b">Quad Tree 및 Prim algorithm 시각화 비행기 게임</Text>
          입니다.
          <br />
          2학년 학생 4명의 팀으로 진행했고 대부분의 학생들이 C언어밖에 배우지
          못한 상황이어서 구현의 전반적인 부분을 도맡아 진행하였습니다.
        </Paragraph>
        <Paragraph>
          프로젝트 발표 후 <Text as="b">우수 프로젝트로 선정</Text>되어
          소프트웨어 학과의 날 교수님들과 많은 기업체 대표님들, 관계자분들
          앞에서 발표할 수 있는 기회를 얻게 되었고, 교수님의 권유로 상점 기능,
          랭킹 시스템을 추가했습니다.
          <br />
          <Text as="b">바닐라 자바스크립트</Text>만으로 모든 게임의 기능, UI,
          상점을 구현했으며 랭킹 시스템은 <Text as="b">MariaDB와 PHP</Text>로
          구현했습니다.
        </Paragraph>
      </Container>
    </Layout>
